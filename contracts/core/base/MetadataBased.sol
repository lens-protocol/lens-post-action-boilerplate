...
abstract contract MetadataBased is IMetadataBased {
    ...
    bytes32 constant STORAGE__METADATA_URI =
        0x1e3609457e69da9dd0dabac13fb8ca9b651f93d6966199d652f92264e8b2ea10;

    function $metadataStorage()
        internal
        pure
        returns (MetadataURIStorage storage _storage)
    {
        assembly {
